...
def main(client):
    ...
    # Create the selector.
    selector = {'campaignEstimateRequests': campaign_estimate_requests, 'platformEstimateRequested': True}
...
if __name__ == '__main__':
    ...
    adwords_client = adwords.AdWordsClient.LoadFromStorage(os.getcwd() + "/googleads.yaml")
    main(adwords_client)
